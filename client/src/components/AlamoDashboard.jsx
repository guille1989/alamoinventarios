...
class AlamoDashboard extends Component {
    ...
    handlreFiltro = () => {
        ...
        const requestOptions ={
          ...
          fetch('http://localhost:80/api/leerexistenciasalamofiltro/'+ this.state.itemFiltro + '/' + this.state.fechaInicio + '/' + this.state.fechaFinal, requestOptions)
    ...
    onChangeFiltroExistencias = (e) => {
        ...
        const requestOptions ={
          ...
          fetch('http://localhost:80/api/leerexistenciasalamofiltro/'+ e.target.value, requestOptions)
              .then(response => response.json())
              .then(data => {
                  console.log(data)
                  this.setState({
    ...
    componentDidMount(){
        //Fetch para enviar informacion al backend:
          ...
          fetch('http://localhost:80/api/leerexistenciasalamogeneral', requestOptions)
              .then(response => response.json())
              .then(data => {
                  this.setState({
                      dataExistencias : data.data
