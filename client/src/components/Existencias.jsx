...
class existencias extends Component {
    ...
    componentDidMount(){
        ...
        const requestOptions ={
          ...
          fetch('http://localhost:80/api/leerexistenciasitemalamo/' + this.props.existenciaItemAlamo, requestOptions)
    ...
    handleInfoRevExistencia = (existencia, lote) => {
        ...
        const requestOptions ={
          ...
          fetch('http://localhost:80/api/leerexistenciasalamorevision/' + existencia +'/'+ lote, requestOptions)
              .then(response => response.json())
              .then(data => {
                this.setState({
                    dataRev: data.data
            ...
            this.state.GramosExistenciaAlamo === '')
        {
                ...
                )
            {
                ...
                const requestOptions ={
                  ...
                  fetch('http://localhost:80/api/insertrevisionexistencias', requestOptions)
                    .then(response => response.json())
                    .then(data => {
                        this.setState({
                            revExistencia: !this.state.revExistencia
