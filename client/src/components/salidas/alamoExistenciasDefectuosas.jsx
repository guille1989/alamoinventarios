...
class alamoExistenciasDefectuosas extends Component {
      ...
      registrarExistenciaAlamo = () => {
        if(this.state.responsableRecepcionExistencia === '' || 
          ...
          const requestOptions ={
           ...
           //POST RESTA
           fetch('http://localhost:3001/api/leerellenadodefectuosas', requestOptions)
           ...
           .then(data => {
             ...
             if(typeof data.err !== 'undefined' && data.err.message.length > 0){
              ...
              fetch('http://localhost:3001/api/leerregistrodefectuosas/' + 'SinDato', requestOptions)
                  .then(response => response.json())
                  .then(data => {
    ...
    fetch('http://www.alamoinventario.com:80/api/crudsalidaexistenciasalamo', requestOptions)
      ...
      handleFechaSalidas = (e) => {
        ...
        fetch('http://localhost:3001/api/leerregistrodefectuosas/' + e.target.value, requestOptions)
            .then(response => response.json())
            .then(data => {
      ...
      handleRLlotebotellas = (existencia, tipoe) => {
        ...
        const requestOptions ={
          ...
          fetch('http://localhost:3001/api/leerRlotebotellasdefectuosas/' + existencia + '/' + tipoe, requestOptions)
              .then(response => response.json())
              .then(data => {
