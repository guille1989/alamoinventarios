...
class alamoExistenciasDefectuosas extends Component {
    constructor(props){
        super(props);    
        this.state={
          dataExistencias: [],
      ...
      registrarExistenciaAlamo = () => {
        if(this.state.responsableRecepcionExistencia === '' || 
          ...
          const requestOptions ={
           ...
           //POST RESTA
           fetch('http://www.alamoinventario.com:80/api/leerellenadodefectuosas', requestOptions)
           ...
           .then(data => {
             ...
             if(typeof data.err !== 'undefined' && data.err.message.length > 0){
              ...
              fetch('http://www.alamoinventario.com:80/api/leerregistrodefectuosas/' + 'SinDato', requestOptions)
                  .then(response => response.json())
                  .then(data => {
    ...
    fetch('http://www.alamoinventario.com:80/api/crudsalidaexistenciasalamo', requestOptions)
      ...
      handleFechaSalidas = (e) => {
        ...
        fetch('http://www.alamoinventario.com:80/api/leerregistrodefectuosas/' + e.target.value, requestOptions)
            .then(response => response.json())
            .then(data => {
      ...
      handleRLlotebotellas = (existencia, tipoe) => {
        ...
        const requestOptions ={
          ...
          fetch('http://www.alamoinventario.com:80/api/leerRlotebotellasdefectuosas/' + existencia + '/' + tipoe, requestOptions)
              .then(response => response.json())
              .then(data => {
        ...
        return (
          <div>
            <div className='tituloDeExistencias'>
              <h3 className='tituloAlamo'>REGISTRO EXISTENCIAS DEFECTUOSAS - ALAMO</h3>
            </div>
            ...
            <Button className='botonAgregarExistencia' color="success" 
                onClick={() => {
                    ...
                    }}>Registrar Existencias Defectuosas</Button>
            ...
            <thead>
              <tr>
                <th>Fecha Registro Existencia Defectuosa</th>
            ...
            <Label>
                Registro Existencias Defectuosas
            </Label>
            ...
            <p className='avisoNoDispo' id='avisoNoDE'>Existencias no disponibles, hay: {Number(this.state.cantidadlimiteBotella).toLocaleString('us')}</p>
              ...
              <ModalFooter>
                <Button color="primary" onClick={this.registrarExistenciaAlamo}>
                  Registrar Existencias Defectuosas
                </Button>
...
export default alamoExistenciasDefectuosas;