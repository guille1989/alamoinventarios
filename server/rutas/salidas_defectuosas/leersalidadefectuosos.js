...
const RegDefectuoso = require('../../model/alamosalidaregistrodefectuosos');
        ...
        resultBAux.map(async (item, index) => {          
            if(countSaludaAux != 0){
                if( parseInt(item.ExistenciasLlenado) >=  parseInt(countSaludaAux)){                
                    ...
                    actuAuxBotellas = await Existencias.updateOne({PresentacionInsumo: body.tipoexistencia, ExistenciasLote: item.ExistenciasLote},{$set:{ExistenciasDefectuosas: parseInt(countResiduo) + item.ExistenciasDefectuosas, ExistenciasLlenado: parseInt(item.ExistenciasLlenado) - parseInt(countResiduo)}})
                }else{
                    ...
                    actuAuxBotellas = await Existencias.updateOne({PresentacionInsumo: body.tipoexistencia, ExistenciasLote: item.ExistenciasLote},{$set:{ExistenciasDefectuosas: item.ExistenciasDefectuosas  + parseInt(item.ExistenciasLlenado), ExistenciasLlenado: 0}})
                }
            }           
        })
        ...
        resultBAux.map(async (item, index) => {          
            if(countSaludaAux != 0){
                if( parseInt(item.ExistenciasLlenado) >=  parseInt(countSaludaAux)){                
                    ...
                    actuAuxBotellas = await TapasEx.updateOne({PresentacionInsumo: body.tipoexistencia, ExistenciasLote: item.ExistenciasLote},{$set:{ExistenciasDefectuosas: parseInt(countResiduo) + item.ExistenciasDefectuosas, ExistenciasLlenado: parseInt(item.ExistenciasLlenado) - parseInt(countResiduo)}})
                }else{
                    countSaludaAux = countSaludaAux - item.ExistenciasLlenado
                    countResiduo = countResiduo - item.ExistenciasLlenado
                    salidaAux.push({numero_botellas_salida: (item.ExistenciasLlenado), stock_lote_botellas: item.ExistenciasLote}) 

                    actuAuxBotellas = await TapasEx.updateOne({PresentacionInsumo: body.tipoexistencia, ExistenciasLote: item.ExistenciasLote},{$set:{ExistenciasDefectuosas: item.ExistenciasDefectuosas  + parseInt(item.ExistenciasLlenado), ExistenciasLlenado: 0}})
                }
            }           
        })
        ...
        resultBAux.map(async (item, index) => {          
            if(countSaludaAux != 0){
                if( parseInt(item.ExistenciasLlenado) >=  parseInt(countSaludaAux)){                
                    ...
                    actuAuxBotellas = await EtiquetasEx.updateOne({PresentacionInsumo: body.tipoexistencia, ExistenciasLote: item.ExistenciasLote},{$set:{ExistenciasDefectuosas: parseInt(countResiduo) + item.ExistenciasDefectuosas, ExistenciasLlenado: parseInt(item.ExistenciasLlenado) - parseInt(countResiduo)}})
                }else{
                    countSaludaAux = countSaludaAux - item.ExistenciasLlenado
                    countResiduo = countResiduo - item.ExistenciasLlenado
                    salidaAux.push({numero_botellas_salida: (item.ExistenciasLlenado), stock_lote_botellas: item.ExistenciasLote}) 

                    actuAuxBotellas = await EtiquetasEx.updateOne({PresentacionInsumo: body.tipoexistencia, ExistenciasLote: item.ExistenciasLote},{$set:{ExistenciasDefectuosas: item.ExistenciasDefectuosas  + parseInt(item.ExistenciasLlenado), ExistenciasLlenado: 0}})
                }
            }           
        })
    }    
